...
import dev.davlatov.wallpapers.databinding.FragmentHomeBlackBinding
import dev.davlatov.wallpapers.util.ApiKeyList
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class HomeBlackFragment : BaseFragment() {
    private var _binding: FragmentHomeBlackBinding? = null
    private val binding get() = _binding!!
    var photosList = ArrayList<SearchResult>()
    private var pageCount = 1
    private var perPageCount = 30
    private var searchName = "Dark"
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_home_black, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        _binding = FragmentHomeBlackBinding.bind(view)
        recyclerViewManager()
