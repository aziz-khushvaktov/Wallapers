...
import dev.davlatov.wallpapers.databinding.FragmentHome4KBinding
import dev.davlatov.wallpapers.util.ApiKeyList
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class Home4KFragment : BaseFragment() {
    private var _binding: FragmentHome4KBinding? = null
    private val binding get() = _binding!!
    var photosList = ArrayList<SearchResult>()
    private var pageCount = 1
    private var perPageCount = 30
    private var searchName = "4K"
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_home4_k, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        _binding = FragmentHome4KBinding.bind(view)
        recyclerViewManager()
