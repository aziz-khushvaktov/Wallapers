...
import dev.davlatov.wallpapers.databinding.FragmentHomeGamingBinding
import dev.davlatov.wallpapers.util.ApiKeyList
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class HomeCarsFragment : BaseFragment() {
    private var _binding: FragmentHomeGamingBinding? = null
    private val binding get() = _binding!!
    var photosList = ArrayList<SearchResult>()
    private var pageCount = 1
    private var perPageCount = 30
    private var searchName = "Lamborghini"
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_home_cars, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        _binding = FragmentHomeGamingBinding.bind(view)
        recyclerViewManager()
