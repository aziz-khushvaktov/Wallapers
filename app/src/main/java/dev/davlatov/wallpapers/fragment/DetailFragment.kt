...
import dev.davlatov.wallpapers.databinding.FragmentDetailBinding
...
class DetailFragment : BaseFragment(), EasyPermissions.PermissionCallbacks {
            ...
            changeScaleTypeCardView.setOnClickListener {
                when (detailImageView.scaleType) {
                    ImageView.ScaleType.CENTER_CROP -> {
                        ...
                        changeScaleTypeCardView.background.setTint(
                            ContextCompat.getColor(
                                requireContext(),
                                R.color.black
                            )
                        )
                        changeScaleTypeImageView.setImageDrawable(
                            resources.getDrawable(
                                R.drawable.ic_scale_xy,
    ...
    override fun onPermissionsGranted(requestCode: Int, perms: MutableList<String>) {
        saveImage(
            binding.detailImageView.drawable.toBitmap(),
